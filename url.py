...
#api = 'https://staging.epower.amadeus.com/traveltochina/#AdtCount=1&Culture=en-US&DepartureDate=8/19/2015&From=NYC&ManualCostAmount=&ManualCostType=none&Method=Search&QFrom=C&QTo=C&ReturnDate=8/26/2015&To=BJS' 
api='https://staging.epower.amadeus.com/traveltochina/'
...
opener.addheaders=[
	...
	('Referer', 'https://staging.epower.amadeus.com/traveltochina/'),
...
url="https://staging.epower.amadeus.com/traveltochina/GeneralService/GeneralInformationInit"
#AccessURL(url,"",sid, tid)

url="https://staging.epower.amadeus.com/traveltochina/FlightService/AutoComplete"
